...
interface Project {
    ...
    config: {
        ...
        pages?: any[]; // To track if content exists
    };
}
                            ...
                            >
                                ...
                                <div className="p-4 bg-slate-50 border-t border-slate-100 flex items-center justify-between">
                                    <button
                                        ...
                                        className="text-sm font-medium text-red-500 hover:text-red-700 transition-colors flex items-center gap-1 opacity-60 hover:opacity-100"
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <Link
                                            href={`/preview?projectId=${project._id}`}
                                            ...
                                            title={project.status === 'published' ? "View Live Site" : "View Draft Preview"}
                                        >
