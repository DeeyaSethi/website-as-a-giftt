...
import { UserDashboardSection } from "@/client/components/home/UserDashboardSection";
      ...
      <section className="container mx-auto px-6 py-16 md:py-24">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            <Link href="/create" className="card overflow-hidden group cursor-pointer block" style={{ borderColor: '#ffa8c5', background: 'white' }}>
            ...
            <Link href="/create" className="card overflow-hidden group cursor-pointer block" style={{ borderColor: '#b197fc', background: 'white' }}>
              <div className="aspect-[3/4] relative overflow-hidden">
                <Image
            ...
            <Link href="/create" className="card overflow-hidden group cursor-pointer block" style={{ borderColor: '#91c5f5', background: 'white' }}>
              <div className="aspect-[3/4] relative overflow-hidden">
                <Image
            ...
            <Link href="/create" className="card overflow-hidden group cursor-pointer block" style={{ borderColor: '#7dd3c0', background: 'white' }}>
              <div className="aspect-[3/4] relative overflow-hidden">
                <Image
